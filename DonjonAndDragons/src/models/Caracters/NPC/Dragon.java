...
import DonjonAndDragons.src.models.Caracters.interfaces.Monster;
...
public class Dragon extends NPC implements Monster{
    public Dragon(Board board,int position) {
        ...
        try {
            this.setStats(new Stats (10*this.getLevel()+1, this.getLevel(), 1, this.getLevel()+10, this.getLevel(), 0));
